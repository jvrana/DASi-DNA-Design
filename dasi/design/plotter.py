    ...
    def plot(self):
        ...
        for i, seg in enumerate(self.segments):
            ...
            if x1 < x2:
                ...
                # add cpst
                xtext = (seg[0] + seg[1]) / 2.
                ax.text(xtext, y + self.text_spacer, str(cost), horizontalalignment='center', verticalalignment='bottom')

                # add label
                ax.text(self.length, y, name, horizontalalignment='left', verticalalignment='center')
                ax.add_line(line)
                y -= 1
            else:
                if segtype == 'overhang':
                    ...
                    xtext = (x1 + x2) / 2.
                    ax.text(xtext, y - 2 * self.text_spacer, str(cost), horizontalalignment='center', verticalalignment='top')
